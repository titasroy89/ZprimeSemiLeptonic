...
#path_data=/nfs/dust/cms/group/zprime-uhh/Analysis_UL18_QCDNN/muon/workdir_QCDDNN_UL18_muon/uhh2.AnalysisModuleRunner. 
path_data=/nfs/dust/cms/group/zprime-uhh/Analysis_UL18_QCDNN/electron/workdir_Analysis_UL18_electron/uhh2.AnalysisModuleRunner.
...
mkdir $pathGL_code/ZprimeSemiLeptonic/data/Skimming_datasets_UL18_ele_NNimpl/
cd $pathGL_code/ZprimeSemiLeptonic/data/Skimming_datasets_UL18_ele_NNimpl/
